...
G4VPhysicalVolume* B4cDetectorConstruction::DefineVolumes()
{
  ...
  auto simpleBoxVisAtt= new G4VisAttributes(G4Colour(1.0,1.0,0));
  simpleBoxVisAtt->SetVisibility(true);
  //calorLV->SetVisAttributes(simpleBoxVisAtt);

  absorberLV->SetVisAttributes(G4Colour(1.0,1.0,0)); // amarillo 
  gapLV->SetVisAttributes(G4Colour(1.0,0,0));        // rojo
