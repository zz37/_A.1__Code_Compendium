...
{  
  ...
  analysisManager->FillNtupleDColumn(4,event->GetPosition().getX());
  analysisManager->FillNtupleDColumn(5,event->GetPosition().getY());
  analysisManager->FillNtupleDColumn(6,event->GetPosition().getZ());
